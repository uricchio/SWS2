...
python translate_fasta.py infiles/SWS2_in_tree.noHyph.fasta > output/SWS2_in_tree.noHyph.With_tblastn.translated.fasta

# run a blast on the SWS2 sequences using the Oophaga databse
python run_blast.SWS2.protein.py ../synteny/OophagaDB/Oophaga.0 7 

# make a fasta that nw includes the results of the blast search, using hits with evals < 1e-10
python make_fasta_from_tblastn7.py 1e-10 output/SWS2_results.7.tblastn.txt ../synteny/pumilio_data/Oophaga.clean.newest.fa >> output/SWS2_in_tree.noHyph.With_tblastn.translated.fasta 
